...
- **Parallel repository processing** — defaults to four times the logical CPU count, capped at 32; tune with `--workers` or `GHORGSYNC_WORKERS` ([details](docs/USAGE.md#repository-concurrency))
